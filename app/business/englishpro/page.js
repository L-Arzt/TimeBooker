...
import ContactForm from '../[slug]/ContactForm'
import ReviewsCarousel from '../[slug]/ReviewsCarousel'

export default async function EnglishProPage() {
    // Business data
    const business = {
        name: 'EnglishPro',
        ...
        <section className="relative bg-white">
            ...
            <section className="relative mt-20 mb-10 bg-white flex items-center justify-center">
                ...
                <div className="bg-gradient-to-r from-[#FFF3E0] to-[#FFECB3] rounded-3xl p-10 max-w-4xl relative z-10">
                    <h2 className="text-[#E74C3C] text-3xl font-bold mb-6 text-center">Акция для новых учеников</h2>
                    <p className="text-[#5D6D7E] text-xl mb-6 text-center">
                        Пробное занятие всего за <span className="text-[#E74C3C] font-bold">299 рублей</span>!<br />
                        Запишитесь сейчас и получите персональную консультацию по уровню языка.
                    </p>
