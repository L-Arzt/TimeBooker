  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[#D9D9D9]  text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-[#D9D9D9]  focus:text-primary-foreground",
        day_today: " text-accent-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle:
          "aria-selected:bg-[#D9D9D9]  aria-selected:text-accent-foreground",
